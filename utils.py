...
def create_binary_list_from_int(number: int) -> List[int]:
    """Creates a list of the binary representation
...
def generate_even_data(
    ...
    # create a list of labels all one because all numbers are even
    labels = [1] * batch_size
...
def convert_float_matrix_to_int_list(
    ...
    Args:
        float_matrix: A matrix of values between 0 and 1 which we want to threshold and convert to integers
